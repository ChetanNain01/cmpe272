...
if(isset($_COOKIE['lastVisited'])){
	...
	$query1="SELECT * FROM product where id in ($lastVisited)";
...
<html lang="en">
  ...
  <div class="collection_text">Last Visited</div>

  <?php if($products == '') {?>
				<center><h1>No Information avaliable</h1></center>
  <?php }?>
   ...
   <div class="about_main layout_padding">
    <div class="layout_padding gallery_section">
    	<div class="container">
    		<div class="row">
			<?php while($products !='' && $product = $products->fetch_row()) {?>
				<div class="col-sm-4" onclick="setLastVisitedCookie(<?php echo $product[0]?>)">
