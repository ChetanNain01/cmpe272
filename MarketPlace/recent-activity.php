...
<center><h2 style="color: #777">Recent Activities</h2></center>

<h4 class="px-3"> Top 5 recent activities in <?php echo $domains[0]?></h4>
<div class="panel-body m-3" style="background-color: white">
        <?php $i = 1; while($row = $result1->fetch_row()) {?>
            <div class='d-sm-flex justify-content-between border-sm-bottom'> <p><?php echo $i?></p><p><?php echo $row[2]?></p> <p><?php echo $row[3]?></p>  <p><a href='<?php echo $row[1]?>'><?php echo $row[1]?></a></p> </div>
        <?php $i = $i+1; }?>
    </div>
  ...
  <div class="panel-body m-3" style="background-color: white">
  <?php $i = 1; while($row = $result2->fetch_row()) {?>
            <div class='d-sm-flex justify-content-between border-sm-bottom'> <p><?php echo $i?></p><p><?php echo $row[2]?></p> <p><?php echo $row[3]?></p>  <p><a href='<?php echo $row[1]?>'><?php echo $row[1]?></a></p> </div>
        <?php $i = $i+1; }?>
    </div>
    ...
    <div class="panel-body m-3" style="background-color: white">
    <?php $i = 1; while($row = $result3->fetch_row()) {?>
            <div class='d-sm-flex justify-content-between border-sm-bottom'> <p><?php echo $i?></p><p><?php echo $row[2]?></p> <p><?php echo $row[3]?></p>  <p><a href='<?php echo $row[1]?>'><?php echo $row[1]?></a></p> </div>
        <?php $i = $i+1; }?>
    </div>
    ...
    <div class="panel-body m-3" style="background-color: white">
    <?php $i = 1; while($row = $result4->fetch_row()) {?>
            <div class='d-sm-flex justify-content-between border-sm-bottom'> <p><?php echo $i?></p><p><?php echo $row[2]?></p> <p><?php echo $row[3]?></p>  <p><a href='<?php echo $row[1]?>'><?php echo $row[1]?></a></p> </div>
        <?php $i = $i+1; }?>
    </div>
